...
# adb工具路径
adb_path = r".\adb\platform-tools\adb.exe"
...
def start_main_activity( dataset_path , model_path,batch_size = 200):
#def start_main_activity(dataset_path=r"C:\Users\komorip\Desktop\daliy\python\wrb\Simplify-main\dataset\dataset",model_path=r"C:\Users\komorip\Desktop\daliy\python\wrb\Simplify-main\SqueezeNetV1.1.pt",batch_size=200):
    logcat_clean()
    # 获取应用文件夹
    file_dir_path = ""
    try:
